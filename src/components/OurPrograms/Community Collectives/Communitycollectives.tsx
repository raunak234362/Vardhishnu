...
import { Users, RefreshCw, ShieldCheck, Check, MapPin, ExternalLink, Repeat } from "lucide-react";
...
const CommunityCollectives = () => {
  ...
  const cohorts = [
    ...
    },
    {
      ...
      focus: "Taking education and dignity to every doorstep of Mir, Banjara & Fakir Community",
      link: "#"
    },
    {
      name: "Priti & Anil",
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 mb-24 lg:mb-32">
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl text-dark tracking-tight leading-tight">
              ...
              <span className="text-dark/80">Nurturing Grassroots <br /> Changemakers</span>
            </h2>
            
            <p className="text-xl text-dark/70 leading-relaxed">
              Join our one-year incubation program empowering grassroots leaders to create lasting change in their communities through education and mentorship.
            </p>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-start gap-16 lg:gap-24 mb-24 lg:mb-32 relative">
          ...
          >
            ...
            <div className="space-y-8 text-xl text-dark/70 leading-relaxed">
              <p>
                Community Collectives is a one-year incubation program designed to share our experience in building community learning spaces.
              </p>
              <p>
                We support grassroots leaders, individuals, and early-stage initiatives working with children from economically disadvantaged backgrounds—equipping them with the skills, resources, and visibility needed to scale their impact.
              </p>
              <p>
                Our unique incubation model helps participants kick-start their journey, strengthen their work, and achieve meaningful outcomes efficiently and sustainably.
              </p>
            </div>
          </motion.div>
        ...
        <div className="mb-24 lg:mb-32">
          ...
          >
            ...
            <p className="text-xl text-dark/40">
              We're looking for passionate individuals ready to make a lasting difference
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8">
            ...
            >
              ...
              <ul className="space-y-4 text-lg text-dark/70 list-disc pl-5">
                <li>Individuals, initiatives, or organisations working with—or aspiring to work with—children from economically disadvantaged backgrounds</li>
            ...
            >
              ...
              <ul className="space-y-4 text-lg text-dark/70 list-disc pl-5">
                ...
                <li>Commitment to continue working with children for at least 2 years after the incubation ends</li>
                <li>Availability to attend all in-person training workshops, participate in field visits, regular follow-ups, and webinars</li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4">
                <p className="text-lg text-dark/70 italic">If you're at an early stage or still ideating:</p>
                <ul className="space-y-4 text-lg text-dark/70 list-disc pl-5">
                  <li>You must initiate on-ground work within the first 6 months of incubation (before the second residential workshop)</li>
                  <li>Submit a detailed 6-month action plan as part of your onboarding</li>
                </ul>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mb-24 lg:mb-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-8">
              ...
              >
                <div className="w-12 h-12 bg-pink-100 text-pink-600 rounded-xl flex items-center justify-center text-2xl mb-8">1</div>
                <h3 className="text-2xl text-dark mb-4">Residential Training Workshops</h3>
                <p className="text-pink-600 mb-8 uppercase tracking-wider text-sm">4 Residential Workshops of 4 Days Each</p>
                <div className="space-y-6 text-lg text-dark/70 leading-relaxed">
                  <p>Through three fully-funded residential workshops, we dive deep into the heart of building impactful learning spaces.</p>
                  <p className="text-dark">These immersive sessions focus on:</p>
                  <ul className="space-y-3 list-disc pl-5">
                    <li>Teaching-learning practices that truly connect with children</li>
                    <li>Designing meaningful content tailored for diverse learning needs</li>
                    <li>Strengthening administration and governance to build sustainable and effective organisations</li>
                    <li>Getting pitch ready - Proposal Writing, budgeting, pitch-presentation</li>
                    <li>Fundraising</li>
              ...
              <motion.div
                ...
                className="bg-white border border-gray-100 rounded-[2.5rem] p-10 shadow-sm hover:shadow-xl transition-all duration-500"
              >
                <div className="w-12 h-12 bg-orange-100 text-orange-600 rounded-xl flex items-center justify-center text-2xl mb-8">4</div>
                <h3 className="text-2xl text-dark mb-4">Networking & Resource Sharing</h3>
                <p className="text-orange-600 mb-8 uppercase tracking-wider text-sm">Be Part of a Growing Community</p>
                <p className="text-lg text-dark/70 leading-relaxed">
                  Gain access to a powerful network of peers, mentors, and resources. Share experiences, collaborate on projects, and grow together within a supportive ecosystem dedicated to grassroots change.
                </p>
              </motion.div>
            </div>
            ...
            <div className="space-y-8">
              <motion.div
                ...
                className="bg-white border border-gray-100 rounded-[2.5rem] p-10 shadow-sm hover:shadow-xl transition-all duration-500"
              >
                <div className="w-12 h-12 bg-indigo-100 text-indigo-600 rounded-xl flex items-center justify-center text-2xl mb-8">2</div>
                <h3 className="text-2xl text-dark mb-4">Field Visits</h3>
                <p className="text-indigo-600 mb-8 uppercase tracking-wider text-sm">2 Field Visits of 3 Days Each</p>
                <p className="text-lg text-dark/70 leading-relaxed">
                  We provide on-ground support through two field visits during the incubation year, offering hands-on guidance, feedback, and mentoring to strengthen implementation and stay aligned with your vision.
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-white border border-gray-100 rounded-[2.5rem] p-10 shadow-sm hover:shadow-xl transition-all duration-500"
              >
                <div className="w-12 h-12 bg-green-100 text-green-600 rounded-xl flex items-center justify-center text-2xl mb-8">3</div>
                <h3 className="text-2xl text-dark mb-4">Webinars</h3>
                <p className="text-green-600 mb-8 uppercase tracking-wider text-sm">8 Theme based webinars</p>
                <p className="text-lg text-dark/70 leading-relaxed">
                  Designed around the emerging needs of the cohort, these webinars are led by senior leaders from diverse social organizations—offering insights, strategies, and shared experiences.
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-white border border-gray-100 rounded-[2.5rem] p-10 shadow-sm hover:shadow-xl transition-all duration-500"
              >
                <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center text-2xl mb-8">5</div>
                <h3 className="text-2xl text-dark mb-4">Monthly Support Calls</h3>
                <p className="text-lg text-dark/70 leading-relaxed">
                  Get personalized guidance through monthly check-ins with our team—designed to strengthen your program and support you in building a sustainable, long-term movement.
                </p>
              </motion.div>
            </div>
          </div>
            ...
            {[
              {
                ...
                description: "A unique pitching event that gives you the stage to directly present your work to donors, funders, and CSR representatives—amplifying grassroots voices and unlocking new opportunities for support and collaboration."
              },
              {
                title: "Alumni Retreat",
                description: "Come together once a year to reconnect, rejuvenate, and reflect—celebrating progress, sharing stories, and strengthening bonds within the alumni community."
              },
              {
                title: "Community Katta",
                description: "Be part of a vibrant online space where current cohort members and alumni come together to share, learn, and grow—building solidarity and sparking collective action."
              }
            ].map((item, idx) => (
              <motion.div
                key={idx}
              ...
              >
                <div className="absolute top-0 left-0 right-10 h-16 bg-primary rounded-tl-2xl rounded-br-[3rem] p-4 flex items-center">
                  <h3 className="text-white leading-tight line-clamp-2">{item.title}</h3>
                </div>
                <p className="text-dark/70 leading-relaxed mt-4">{item.description}</p>
              </motion.div>
            ))}
          </div>
            ...
            {[
              {
                ...
                description: "Join specialized workshops led by Vardhishnu's knowledge partners—designed not just for you, but also for your team members, to strengthen skills and deepen your collective impact."
              },
              {
                title: "Need-Based Webinars",
                description: "Need-based webinars led by domain experts, offering timely insights and practical guidance tailored to your challenges on the ground."
              }
            ].map((item, idx) => (
              <motion.div
                key={idx}
              ...
              >
                ...
                <p className="text-dark/70 font-medium leading-relaxed mt-4">{item.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-24 lg:mb-32">
          ...
          <div className="space-y-0 relative">
            ...
            {[
              ...
              >
                <div className={`absolute left-0 w-10 h-10 lg:w-12 lg:h-12 rounded-full border-4 border-white shadow-md flex items-center justify-center z-10 transition-colors duration-500 ${
                  step.status === "checked" ? "bg-primary text-white" : "bg-gray-300 text-white"
                }`}>
                  {step.status === "checked" ? <Check size={24} strokeWidth={3} /> : <div className="w-3 h-3 bg-white rounded-full" />}
                </div>
                <div className="space-y-4">
                  <h3 className="text-2xl md:text-3xl text-dark">{step.title}</h3>
                  <p className="text-lg md:text-xl text-dark/70 leading-relaxed max-w-4xl">{step.text}</p>
                </div>
              </motion.div>
            ))}
          </div>
...
<div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-xl flex flex-col items-center">
  ...
  <div className="relative w-72 h-72 mb-12 flex items-center justify-center">
    <svg viewBox="0 0 100 100" className="w-full h-full overflow-visible">
      {/* Background Guides - matching the thin grey lines in ref */}
      {[10, 20, 30, 40, 50].map((r) => (
        <circle key={r} cx="50" cy="50" r={r} fill="none" stroke="#f0f0f0" strokeWidth="0.5" />
      ))}
      ...
      {/* Urban (Deep Green): Top-Right 0° to 60° (Radius 35)
        Rural (Lightest Green): Top-Left 270° to 360° (Radius 48)
        Tribal (Medium Green): Bottom-Right 60° to 160° (Radius 40)
        Semi-Urban (Lime Green): Bottom-Left 160° to 270° (Radius 25)
      */}
  ...
  {/* Legend - Clean alignment as per reference */}
    ...
    {[
      ...
      <div key={i} className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-5 h-5 rounded-full" style={{ backgroundColor: l.color }} />
          <span className="text-dark  text-xl">{l.label}</span>
        </div>
        <span className="text-dark text-xl">{l.val}</span>
      </div>
    ))}
  </div>
</div>
            ...
            <div className="bg-white rounded-[2rem] p-10 border border-gray-100 shadow-xl flex flex-col items-center">
              <h3 className="text-2xl text-dark mb-10 w-full text-center">Gender - Entrepreneurs</h3>
              <div className="relative w-72 h-72 mb-10 flex items-center justify-center">
                <svg viewBox="0 0 100 100" className="w-full h-full transform -rotate-90">
                  ...
                  {/* Radial Guides */}
                  {[0, 180].map((a) => (
                    <line key={a} x1="50" y1="50" x2={50 + 50 * Math.cos((a * Math.PI) / 180)} y2={50 + 50 * Math.sin((a * Math.PI) / 180)} stroke="#e0e0e0" strokeWidth="0.5" strokeDasharray="2 2" />
                  ))}
                  
                  {/* Male - 66.7 (R=45) */}
                  <path d="M 50 50 L 95 50 A 45 45 0 0 1 5 50 Z" fill="#A3CE31" />
                  {/* Females - 33.3 (R=30) */}
                  <path d="M 50 50 L 20 50 A 30 30 0 0 1 80 50 Z" fill="#DCF888" transform="rotate(180 50 50)" transform-origin="center" />
                </svg>
              </div>
              <div className="space-y-6 w-full pt-6 px-10">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between border-b border-gray-50 pb-4 last:border-0">
                    <div className="flex items-center gap-4">
                      <div className="w-5 h-5 rounded-full border border-gray-100" style={{ backgroundColor: l.color }} />
                      <span className="text-dark  text-xl">{l.label}</span>
                    </div>
                    <span className="text-dark text-xl">{l.val}</span>
                  </div>
        ...
        <div className="mb-24">
          ...
          >
            ...
            <div className="space-y-4 max-w-3xl mx-auto text-xl text-dark font-medium leading-relaxed">
              <p>The submission window for application to 2026 cohort is now closed.</p>
              <p>If you are interested in applying for the program; kindly register your interest for next year here.</p>
            </div>
        ...
        <div className="mb-24 lg:mb-32">
          ...
          <div className="flex justify-center mb-16">
            <div className="inline-flex bg-gray-50/80 p-1.5 rounded-full border border-gray-100 shadow-sm max-w-full overflow-x-auto hide-scrollbar">
              {['Current Cohort', '2024-25', '2023-24', '2022-23', '2021-22', '2020-21'].map((tab) => (
                <button
                  key={tab}
                ...
                <div className="p-10 space-y-6 flex-grow flex flex-col">
                  ...
                  <div className="space-y-4 pt-2">
                    <div className="flex items-start gap-4 text-dark/70">
                      ...
                      <span className="text-lg leading-snug">{member.location}</span>
                    </div>
                    <div className="flex items-start gap-4 text-dark/70">
          ...
          >
            <div className="space-y-3 text-center lg:text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-dark">Stay Updated With Us</h2>
              <p className="text-xl text-dark/40">Get updates, stories to support our mission</p>
            </div>
